...
可以使用新的美区共享ID登陆
要记得在20分钟后退出(每20分钟更改一次密码)`,img:""},{title:"(图) 官网共享ID位置",content:"",img:n(8324)}],windows:[{title:"(图) upup使用教程",content:"",img:URL("https://imwayson.com/dist/img/cloudupup.png")},{title:"V2ray更新upup",content:String.raw`如无法使用，使用新的客户端:cloudupup(红色图标)
新客户端更简洁的页面, 更方便的操作
