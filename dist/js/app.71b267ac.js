...
(1) 打开启动台=>其他=>终端
(2) 打开访达=>直接搜索'终端'
(3) 点击桌面右上角的发动机,搜索'终端'`,img:""}],android:[{title:"Android安装下载",content:String.raw`使用新的客户端:cloudupup(红色图标)
更简洁的页面, 更方便的操作, 更多的线路
自动化更新, 内含永久客服, 官网账号密码登录即可
...
2、下载安装即可使用`},{title:"(图) Android使用教程",content:"",img:n(8601)},{title:"Android无法使用",content:String.raw`安卓无法使用：
